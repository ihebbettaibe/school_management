      ...
      <AppLayout>
        <div className="p-16 space-y-16 max-w-6xl mx-auto">
          <div className="flex flex-col space-y-10 md:flex-row md:items-center md:justify-between md:space-y-0">
            <div>
              <h1 className="text-6xl font-extrabold text-primary font-sans mb-4">My Assignments</h1>
              <p className="text-2xl text-muted-foreground font-semibold">Create and manage assignments for your classes</p>
            </div>
