    ...
    <AppLayout>
      <div className="p-6 space-y-6 bg-background min-h-[80vh]">
        <div className="flex flex-col space-y-2 md:flex-row md:items-end md:justify-between md:space-y-0 border-b pb-4">
          <div>
            <h1 className="text-6xl font-extrabold text-primary tracking-tight font-sans mb-4">Assignments</h1>
            <p className="text-lg text-muted-foreground font-semibold font-sans">Review your child's assignments and homework</p>
          </div>
