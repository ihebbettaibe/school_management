    ...
    <AppLayout>
      <div className="p-6 space-y-6 bg-background min-h-[80vh]">
        <div className="flex flex-col space-y-2 md:flex-row md:items-end md:justify-between md:space-y-0 border-b pb-4">
          <div>
            <h1 className="text-2xl font-semibold text-foreground tracking-tight">Schedule Overview</h1>
            <p className="text-sm text-muted-foreground">Review the weekly timetable for your children</p>
          </div>
